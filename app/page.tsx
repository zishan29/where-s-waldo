...
export default function Home() {
  return (
    <>
      ...
      <div className="hidden h-screen flex-col bg-stone-900 pt-0 md:flex">
        ...
        <main className="mt-10 flex grow flex-col items-center">
          <div className="flex flex-col items-center gap-4 self-center rounded-md bg-stone-800 p-8 text-white shadow-lg sm:w-full md:w-2/3 lg:w-1/2">
            ...
            <div className="text-lg">
              ...
              crowded scenes. Test your observation skills and enjoy the thrill
              of spotting these iconic characters in unexpected places!
            </div>
            <a
              href="/start"
